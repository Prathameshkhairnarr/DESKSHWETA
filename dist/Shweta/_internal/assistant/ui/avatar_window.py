...
from PyQt5.QtWidgets import QMainWindow, QApplication, QLabel, QWidget, QVBoxLayout, QSystemTrayIcon, QMenu, QAction
...
class AvatarWindow(QMainWindow):
    ...
    def __init__(self, on_mic_click: Optional[Callable] = None, on_quick_action: Optional[Callable] = None) -> None:
        ...
        self.drag_bar.setGeometry(0, 0, 400, 30)
        ...
        self.web.setGeometry(0, 30, 400, 620)
